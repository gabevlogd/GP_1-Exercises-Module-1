...
/// </summary>
public abstract class ObjectPooler<TPoolObj> : MonoBehaviour where TPoolObj : Component
{
    [SerializeField]
    ...
    /// <returns></returns>
    public TPoolObj GetObject(bool forced = false)
    {
        TPoolObj result;

        if (_available.Count != 0)
        {
            result = _available[^1]; // prendo l'ultimo elemento
    ...
    public void ReleaseObject(TPoolObj poolObj)
    {
